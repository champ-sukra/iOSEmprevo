...
class HTTPSessionManager {
    ...
    init() {
        self.urlString = "https://apiemprevo.appspot.com/api/values"
//        self.urlString = "http://localhost:50612/api/values"
    }
        
    func requestPOST(_ aParams: [String: Any], aCompletion: @escaping(ObjectEvent) -> Void) {
        var request: URLRequest = URLRequest(url: URL (string: self.urlString)!)
